...
public class GameManager : MonoBehaviour
{
    ...
    private void CheckForMissClick()
    {
        ...
        // Look for a 2D collider under the click.
        Collider2D hitCollider = Physics2D.OverlapPoint(clickPosition);

        // If there is no fruit under the click, count it as a miss.
        if (hitCollider == null || hitCollider.GetComponent<FruitClick>() == null)
        {
            LoseLife();
        }
    }
